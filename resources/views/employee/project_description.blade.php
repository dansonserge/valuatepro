...
<!--start calendar code-->
                     ...
                     {{ Form::text('created_time',null,array('id'=>'date','class'=>'form-control form-control1','value'=>$date, 'placeholder'=>$date))}}
...
<script>
  ...
  <!--end calendar code-->
          ...
          <div class="col-sm-4">
  {{ Form::text('upi_no',null,array('class'=>'form-control1', 'id'=>'focusedinput','placeholder'=>$upi_no))}}

     <p class="help-block"><i>ex:1/03/05/02/205</i></p>
          </div>     
         <label for="focusedinput" class="col-sm-2 control-label">Plot number</label>
          <div class="col-sm-4">
         {{ Form::text('plot_no',null,array('class'=>'form-control1', 'id'=>'focusedinput','placeholder'=>$plot_no))}}
 ...
 @if(isset($is_open_market_value))
 @if($is_open_market_value=='1')
 <input name="is_open_market_value" type="checkbox" checked value="1" >
 @endif
 @if($is_open_market_value=='0')
 <input name="is_open_market_value" type="checkbox" unchecked value="1" >       
 @endif                 
 @else
 <input name="is_open_market_value" type="checkbox" unchecked value="1" > 
 @endif 
 ...
 @if(isset($is_forced_sale_value))
 @if($is_forced_sale_value=='1')
 <input name="is_forced_sale_value" type="checkbox" checked value="1" >
 @endif
 @if($is_forced_sale_value=='0')
 <input name="is_forced_sale_value" type="checkbox" unchecked value="1" >       
 @endif                 
 @else
 <input name="is_forced_sale_value" type="checkbox" unchecked value="1" > 
 @endif 
 ...
 @if(isset($is_insurable_value))
 @if($is_insurable_value=='1')
 <input name="is_insurable_value" type="checkbox" checked value="1" >
 @endif
 @if($is_insurable_value=='0')
 <input name="is_insurable_value" type="checkbox" unchecked value="1" >       
 @endif                 
 @else
 <input name="is_insurable_value" type="checkbox" unchecked value="1" > 
 @endif 
...
$(document).ready(function() {
    ...
    $('#eventForm').formValidation({
        ...
        <div class="col-sm-4">
                 <a class="btn btn-primary next_section" href='{{URL::to("cmp/newprojectback/$projectId")}}'>
