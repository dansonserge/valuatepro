            ...
            <table class="table table-bordered table-sm">
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>{{$mainresidentialareasum}} m<sup>2</sup></td>
				     
				    </tr>
				    <tr>
				      <th scope="row">2.</th>
				      <td>Annex</td>
				      <td>{{$annexareasum}} m<sup>2</sup></td>
				     
				    </tr>
				    <tr>
				      <th scope="row">3.</th>
				      <td>Plot</td>
				      <td>{{$plot_no}} m<sup>2</sup></td>
				    </tr>
				  </tbody>
           </table>

           <h5>7.2 Construction Details</h5>
            <b>Main Residential House</b>
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>
				         ...
				         {{$area}} m<sup>2</sup></br>
				      	  {{$unit_price}} RWF/ m<sup>2</sup></br>
				      	  <b>{{$area*$unit_price}} RWF</b>
				      </td>
				    </tr>
				  </tbody>
            </table>
            ...
            <table class="table table-bordered">
				  ...
				  <tbody>
				    <tr>
				      <th scope="row">1</th>
				      <td>Main Residential house</td>
				      <td><b>{{$mainresidentialareasum*$unit_price}}Rwf</b></td>
				   
				    </tr>
				    <tr>
				      <th scope="row">2</th>
				      <td>Annex</td>
				      <td><b>{{$annexareasum*$unit_price}}Rwf</b></td>
				
				    </tr>
				    <tr>
				      <th scope="row">3</th>
				      <td>Plot</td>
				      <td><b>{{$area*$unit_price}}Rwf</b></td>
				    </tr>
				    <tr>
				      <th scope="row"></th>
				      <td>Open Market Value</td>
				      <td><b>{{($annexareasum*$unit_price)+($mainresidentialareasum*$unit_price)+($area*$unit_price)}}Rwf</b></td>
				    ...
				    <tr>
                      ...
                      <td><b>{{($annexareasum*$unit_price)+($mainresidentialareasum*$unit_price)}}Rwf</b></td>
				    </tr>
				  </tbody>
			</table>
			...
			<ol>
				<li>Open Market Value: Rwf {{($annexareasum*$unit_price)+($mainresidentialareasum*$unit_price)+($area*$unit_price)}} <b>Not found</b></li>
				<li>Forced Sale Value: Rwf <b>Not found</b></li>
				<li>Insurance Value: Rwf {{($annexareasum*$unit_price)+($mainresidentialareasum*$unit_price)}} <b>Not found</b></li>
			</ol>
			</br>
